...
//このクラスは3人戦のみ
const Statistics3 = sequelize.define('Statistics3', {
...
User.hasOne(Statistics3, { foreignKey: 'userId' });
Statistics3.belongsTo(User, { foreignKey: 'userId' });

module.exports = Statistics3;